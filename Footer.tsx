        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              {/* Social icons */}
              <div className="mb-6">
                <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-3 font-bold">
                  {ar ? 'تابعنا' : 'Follow Us'}
                </p>
            ...
            <div>
              ...
              <div className="mt-6 space-y-2">
                <div className="flex items-center gap-2 text-xs text-gray-400">
                  ...
                  <span>{ar ? 'سجل تجاري: 7007004471' : 'CR: 7007004471'}</span>
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-400">
                  <ShieldCheckIcon className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <span>{ar ? 'رقم ضريبي: 310860294900003' : 'VAT: 310860294900003'}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-5 bg-white/5 border border-white/10 rounded-xl p-4">
                ...
                <div className="space-y-1.5 text-xs text-gray-300">
                  <p><span className="text-gray-500">{ar ? 'البنك:' : 'Bank:'}</span> {bankInfo.name}</p>
                  <p><span className="text-gray-500">{ar ? 'الاسم:' : 'Name:'}</span> {bankInfo.holder}</p>
                  <p dir="ltr" className="font-mono text-emerald-300 text-[10px]">IBAN: {bankInfo.iban}</p>
                  <p><span className="text-gray-500">{ar ? 'الفرع:' : 'Branch:'}</span> {bankInfo.branch}</p>
                </div>
              </div>
            </div>
          </div>
