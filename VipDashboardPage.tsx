                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm font-bold text-slate-700 border-b pb-8 mb-8">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between border-b pb-2">
                        ...
                        <span className="text-primary font-mono font-black">7007004471</span>
                      </div>
                      <div className="flex justify-between border-b pb-2">
          ...
          <div className="space-y-12 animate-fade-in">
            ...
            <div className="bg-white p-12 rounded-[4rem] shadow-sovereign border border-gray-100">
              ...
              <div className="border border-slate-200 bg-slate-50/50 p-8 rounded-[2rem] space-y-6 text-sm leading-relaxed text-slate-800 font-bold max-h-[350px] overflow-y-auto mb-10">
                ...
                <p>
                  <strong>{language === 'ar' ? 'الطرف الأول:' : 'First Party:'}</strong> {language === 'ar' ? 'شركة نجوم دلتا للتجارة، سجل تجاري رقم 7007004471، ومقرها جدة، المملكة العربية السعودية.' : 'Delta Stars Trading Company, Commercial Register No. 7007004471, based in Jeddah, KSA.'}
                </p>
            ...
            <div className="p-10 space-y-8 print-container" id="printable-invoice">
              ...
              <div className="flex justify-between items-start border-b pb-8">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-600 font-mono">الرقم الضريبي / VAT: <span className="font-black">310860294900003</span></p>
                </div>
              ...
              <div className="border-t pt-8 text-center space-y-2">
                ...
                <p className="text-[8px] text-gray-400 font-mono">{`رقم التحقق الإلكتروني: ${btoa(String(order?.id ?? Date.now())).slice(0,24).toUpperCase()}`}</p>
              </div>
